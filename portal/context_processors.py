...
def navigation(request):
    ...
    is_portal_scraper = url_name == "portal-scraper"
    ...
    is_management_section = is_staff_nav_visible and not is_portal_section

    if is_portal_scraper:
        brand_label = "Scraper"
    ...
    return {
        ...
        "is_portal_scraper": is_portal_scraper,
